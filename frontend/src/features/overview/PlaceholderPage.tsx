...
export function PlaceholderPage({ page, service, onAskAi }: PlaceholderPageProps) {
    return <section className="collection panel"><h2>{page === "Dashboard" ? "Workspace overview" : page}</h2><p>{descriptions[page](service)}</p><button className="primary-button" onClick={onAskAi}>Explore Ask AI</button></section>;
}
